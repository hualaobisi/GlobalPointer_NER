...
class EntDataset(Dataset):
    ...
    def encoder(self, item):
        if self.istrain:
            ...
            # Map the indices from raw text to token indices
    ...
    def sequence_padding(self, inputs, length=None, value=0, seq_dims=1, mode='post'):
        """Numpy function that pads sequences to the same length"""
        if length is None:
    ...
    def collate(self, examples):
        ...
        # Pad the input and label tensors
